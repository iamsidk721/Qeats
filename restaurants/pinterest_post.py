...
# write your code below
    def publish_photo_msg(self, message, image_url):
        ...
        response = requests.post('https://api.pinterest.com/v1/pins/', params = data)
        print(response.json())
        return
    
if __name__ == '__main__':
    pinterest = Pinterest()
    print(pinterest.board_id)
    ...
    image_url = 'https://4.imimg.com/data4/HI/DG/MY-4575115/chocolate-icecream-flavour-500x500.jpg'
    my_name = 'Sidk'
