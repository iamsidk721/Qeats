...
def get_tags_suggestions(api_key, image_url):
    ...
    response = requests.post('https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs', headers=headers, data=datas)
    response_content = response.json()
    response_content_data = response_content['outputs'][0]['data']['concepts']
    tag_list = []
    for i in response_content_data:
